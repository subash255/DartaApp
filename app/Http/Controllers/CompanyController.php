...
class CompanyController extends Controller
{
    ...
    public function step1($id = null)
    {
        ...
        if ($users->role == 'admin') {
            ...
            $user = $company->user;
            return view('admin.company.step1', ['currentStep' => 'step1','title' => 'Company Details'], compact('company', 'user'));
        } else {
            $user = Auth::user();
    ...
    public function step2($id = null)
    {
        ...
        if ($user->role == 'admin') {
            $company = Company::where('id', $id)->first();
            $user = $company->user;
            return view('admin.company.step2', ['currentStep' => 'step2','title' => 'Company Details'], compact('company', 'user'));
        } else {
    ...
    public function step3($id = null)
    {
        ...
        if ($user->role == 'admin') {
            ...
            return view('admin.company.step3', [
                'company' => $company,
                'user' => $user,
                'currentStep' => 'step3','title' => 'Company Details',
            ]);
        } else {
            // If no ID is provided, fetch the first company of the user
    ...
    public function step4($id = null)
    {
        ...
        if ($user->role == 'admin') {
            ...
            return view('admin.company.step4', [
                'company' => $company,
                'user' => $user,
                'currentStep' => 'step4','title' => 'Company Details',
            ]);
        } else {
            // If no ID is provided, fetch the first company of the user
            $company = Company::where('user_id', $user->id)
    ...
    public function step5($id = null)
    {
        ...
        if ($user->role == 'admin') {
            ...
            return view('admin.company.step5', [
                'company' => $company,
                'user' => $user,
                'currentStep' => 'step5','title' => 'Company Details',
            ]);
        } else {
            // If no ID is provided, fetch the first company of the user
            $company = Company::where('user_id', $user->id)
