    ...
    <div class="container mx-auto p-6">
        <form method="POST" action="{{ route('user.company.step5.update',$company->id) }}">
            ...
            <div class="flex justify-between mt-6">
                <a href="{{route('user.company.step4',$company->id)}}" class="px-4 py-2 bg-gray-300 text-gray-900 rounded-lg hover:bg-gray-400 focus:outline-none focus:shadow-outline">Previous</a>
