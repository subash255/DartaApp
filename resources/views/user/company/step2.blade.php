...
<div class="container mx-auto p-6">
    <form method="POST" action="{{ route('company.stores') }}">
        ...
        <div class="mb-6">
            ...
            <input type="text" name="ward" id="ward" value="{{ old('ward', $company->ward ?? '')  }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-2.5" required>
        </div>
        <div class="mb-6">
            ...
            <input type="email" name="oemail" id="email"
                ...
                required>
                    ...
                    <div class="flex justify-between mt-6">
                        <a href="{{route('user.company.step1')}}" class="px-4 py-2 bg-gray-300 text-gray-900 rounded-lg hover:bg-gray-400 focus:outline-none focus:shadow-outline">Previous</a>
