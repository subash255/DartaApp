        ...
        <form method="POST" action="{{ route('company.stores') }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="mb-6">
                    ...
                    <input type="password" name="cpassword" id="cpassword" value="{{ old('cpassword', $company->cpassword ?? '')  }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-2.5" required>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="mb-6">
                    ...
                    <input type="password" name="rpassword" id="rpassword" value="{{ old('rpassword', $company->rpassword ?? '')  }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-orange-500 focus:border-orange-500 block w-full p-2.5" required>
                </div>
                <div class="mb-6">
