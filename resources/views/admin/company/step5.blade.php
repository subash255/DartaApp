...
<div class="p-4 bg-white shadow-lg -mt-12 mx-4 z-20 rounded-lg">
    ...
    <div class="container mx-auto p-6">
        <form method="POST" action="{{ route('admin.company.step5.update',$company->id) }}">
            @csrf
            @method('PUT')
            ...
            <h3 class="text-lg font-medium text-gray-900 mb-4">Submission no for PAN:</h3>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="mb-6">
            ...
            <div class="flex justify-between mt-6">
                <a href="{{route('admin.company.step4',$company->id)}}" class="px-4 py-2 bg-gray-300 text-gray-900 rounded-lg hover:bg-gray-400 focus:outline-none focus:shadow-outline">Previous</a>
